...
#  ADVERTISED_LISTENERS="PLAINTEXT://kafka-$NODE_ID.$SERVICE.$NAMESPACE.svc.cluster.local:$OFFSET_PORT"
# 
ADVERTISED_LISTENERS="PLAINTEXT://$NODE_NAME:$AD_PORT"
...
## CLUSTER_ID is now set from the container env
# 
